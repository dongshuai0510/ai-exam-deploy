...
const FIELD_ALIASES: Record<keyof ColumnMapping, string[]> = {
  ...
  senderPhone: [
    ...
    'sender phone', 'sender_phone', '发货人电话',
  ],
  senderAddress: [
  ...
  receiverName: [
    ...
    'receiver_name', '收货人名', '收件人名称',
  ],
  receiverPhone: [
    '收件人电话', '收件人手机', '收货电话', '收件人联系方式', '收货人电话', 'receiver tel', 'receiver_tel',
    'receiver phone', 'receiver_phone', '收货电话', '收件人联系电话',
  ],
  receiverAddress: [
  ...
  quantity: [
    '件数', '数量', '包裹数量', '件数(件)', 'qty', 'quantity', 'count', '数量(件)',
  ],
  tempZone: [
    '温层', '温度要求', '运输', '冷链类型', '温控', '温区', 'temp zone', 'temp_zone', 'temperature',
    '温度', '冷链', '运输方式', '温层要求',
  ],
  note: [
    '备注', '附言', '说明', '附加说明', '备注信息', 'note', 'notes', 'remark', 'remarks', '附注',
  ],
}
